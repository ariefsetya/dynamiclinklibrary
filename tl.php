...
?>
Tidak ada status<br>
<a style="position:absolute;right:100;font-size:18pt;" href="direct.php?rpl=myfriend&src_a=0&src_b=<?php echo $limitan;?>&awal">Kembali</a>
<?php
}
else{
...
<?php
if($ew['host']==$_SESSION['id'] or $ew['tujuan'] == $_SESSION['id']){
?>
	<a style="color:<?php echo $_SESSION['navbar'];?>;background:<?php echo $_SESSION['background'];?>" href="diletstatus.php?next=fren&prof=<?php echo $det;?>&art=<?php echo $ew['id'];?>"><i title="Hapus" class=icon-remove></i></a>
<?php
}
...
if(empty($like['id'])){
?>
<a style="color:<?php echo $_SESSION['navbar'];?>;background:<?php echo $_SESSION['background'];?>" href="likeinstatus.php?next=fren&prof=<?php echo $det;?>&det=<?php echo $ew[id];?>&id=<?php echo $_SESSION['id'];?>"><i title="<?php echo $mm; ?> Suka" class=icon-thumbs-up></i></a>
<?php
}
else if(!empty($like['id'])){
?>
<a style="color:<?php echo $_SESSION['navbar'];?>;background:<?php echo $_SESSION['background'];?>" href="likeoutstatus.php?next=fren&prof=<?php echo $det;?>&det=<?php echo $ew[id];?>&id=<?php echo $_SESSION[id];?>"><i title="<?php echo $mm; ?> Suka" class=icon-thumbs-down></i></a>
<?php
}
?>
...
$rojml = mysql_query("select*from timeline where tujuan='$det' or host='$det' order by id desc");
$jml = mysql_num_rows($rojml);
if($jml > $limitan){
?>
<div class="place-right" style="padding-top:20px;">
	<a href="direct.php?rpl=myfriend&det=<?php echo $det;?>&src_a=<?php echo $awal;?>&src_b=<?php echo $limitan;?>&back="><i type="submit" name="lanjut" style="font-size:30pt;color:<?php echo $_SESSION['navbar'];?>;background:<?php echo $_SESSION['background'];?>" class="icon-arrow-left-3"></i></a>
	<a href="direct.php?rpl=myfriend&det=<?php echo $det;?>&src_a=<?php echo $awal;?>&src_b=<?php echo $limitan;?>&next="><i type="submit" name="lanjut" style="font-size:30pt;color:<?php echo $_SESSION['navbar'];?>;background:<?php echo $_SESSION['background'];?>" class="icon-arrow-right-3"></i></a>
</div>
<?php
}
